...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <!-- =========================================================================== -->
    <!-- BUTTON: App Info / Restricted Settings                                      -->
    <!-- SUMMARY: Opens the App Info page where users can tap the 3-dot menu to      -->
    <!--          find "Allow Restricted Settings". This is needed on Android 13+   -->
    <!--          for sideloaded apps to enable accessibility services.              -->
    <!-- =========================================================================== -->
    <LinearLayout
        ...
        <LinearLayout
            ...
            <TextView
                android:layout_width="wrap_content"
                android:layout_height="wrap_content"
                android:text="Tap → 3-dot menu → Allow Restricted"
                android:textColor="#888888"
                android:textSize="12sp"/>
        </LinearLayout>
        <ImageView
